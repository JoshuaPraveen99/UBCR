...
public class Hatchback extends Taxi{
	...
	public Hatchback(String carType, String currentSpot, String name, String carModel, String vehicleNumber,
			String contact, double freeTime, int totalEarnings, int taxi_id, boolean booked) {
